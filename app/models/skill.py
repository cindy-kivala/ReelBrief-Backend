...
class FreelancerSkill(db.Model):
    ...
    proficiency = db.Column(db.String(50), default="intermediate")  # beginner, intermediate, expert

    # Relationships
    skill = db.relationship(
        "Skill", back_populates="freelancer_skills", overlaps="freelancer_profiles,skills"
    )
