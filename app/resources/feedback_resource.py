...
def submit_feedback():
    try:
        ...
        return (
            jsonify({"error": "Failed to submit feedback", "message": str(e), "success": False}),
            500,
        )
...
def get_deliverable_feedback(deliverable_id):
    try:
        ...
        if not deliverable:
            return jsonify({"error": "Deliverable not found", "success": False}), 404
        ...
        return (
            jsonify({"error": "Failed to fetch feedback", "message": str(e), "success": False}),
            500,
        )
...
def resolve_feedback(feedback_id):
    try:
        ...
        if not feedback:
            return jsonify({"error": "Feedback not found", "success": False}), 404
        ...
        db.session.rollback()
        return (
            jsonify({"error": "Failed to resolve feedback", "message": str(e), "success": False}),
            500,
        )
...
def unresolve_feedback(feedback_id):
    try:
        ...
        db.session.rollback()
        return (
            jsonify({"error": "Failed to unresolve feedback", "message": str(e), "success": False}),
            500,
        )
